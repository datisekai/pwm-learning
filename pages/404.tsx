...
const NotFoundPage = () => {
  ...
  return (
    <>
    <Meta image="/images/not-found.jpg" title="Page not found" description=""/>
      <div className="bg-gray-100 h-screen justify-center">
        ...
        <center className="mt-6">
          <div
          onClick={() => router.back()}
            className="inline text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md"
          >
            Go back{" "}
          </div>
        </center>
