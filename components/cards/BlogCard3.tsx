...
const BlogCard3: FC<BlogCard3Props> = ({
  ...
  return (
    <div className="mt-2 first:mt-0">
      ...
      />
      <h1 className="mt-2 line-clamp-3 text-md  md:text-lg hover:underline cursor-pointer transition-all ">
      ...
      {isDesc && (
        <p className="mt-2 line-clamp-2 text-sm md:text-md text-gray-800">
