...
import { AiOutlineRight, AiOutlinePlusCircle, AiFillTwitterCircle, AiFillYoutube } from "react-icons/ai";
        ...
        <div className="flex-1 flex flex-col items-center md:items-start px-2">
          ...
          <div className="flex items-center mt-2">
            <div className="p-2 rounded-full border cursor-pointer ">
              <AiFillTwitterCircle className="text-white" fontSize={24} />
            </div>
            <div className="p-2 rounded-full border cursor-pointer ml-2">
              <AiFillYoutube className="text-white" fontSize={24} />
            </div>
            <div className="p-2 rounded-full border cursor-pointer ml-2">
