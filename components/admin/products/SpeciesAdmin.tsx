  ...
  return (
    ...
    <div className="mt-5">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setOpenModalAdd(true)} className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-700">
          Thêm chủng loại
        </button>
      </div>
      <div
    ...
    <ModalAddSpecies handleClose={() => setOpenModalAdd(false)} open={openModalAdd}/>
    <ModalUpdateSpecies current={current} handleClose={() => setOpenModalUpdate(false)} open={openModalUpdate}/>
    </>
  );
};
